...
merge.a.one <- function(x,data1,data2,by1="uf",by2="municipio",...) {
...
merge.approx <- function(x,data1,data2,by1,by2,...) {
  data1[,by1] <- as.character(tolower(data1[,by1]))
  data2[,by1] <- as.character(tolower(data2[,by1]))
  data1[,by2] <- as.character(tolower(data1[,by2]))
  data2[,by2] <- as.character(tolower(data2[,by2]))
