...
data.votacoes$resultado <- with(data.votacoes, paste('<img src="../images/',datavot,'.',numvot,'barsmall.png','" height=45 width=45 />',sep=''))
data.votacoes$resultado <- with(data.votacoes, paste('<a href="../images/',datavot,'.',numvot,'bar.png','">',resultado,'</a>',sep=''))
